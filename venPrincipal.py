...
class Ui_venPrincipal(object):
    def setupUi(self, venPrincipal):
        ...
        self.lblFecha = QtWidgets.QLabel(self.panelCliente)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.lblFecha.sizePolicy().hasHeightForWidth())
        self.lblFecha.setSizePolicy(sizePolicy)
        self.lblFecha.setMinimumSize(QtCore.QSize(90, 25))
        self.lblFecha.setMaximumSize(QtCore.QSize(90, 25))
        self.lblFecha.setObjectName("lblFecha")
        self.layout1.addWidget(self.lblFecha)
        self.editFecha = QtWidgets.QLineEdit(self.panelCliente)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.editFecha.sizePolicy().hasHeightForWidth())
        self.editFecha.setSizePolicy(sizePolicy)
        self.editFecha.setMinimumSize(QtCore.QSize(90, 20))
        self.editFecha.setMaximumSize(QtCore.QSize(90, 20))
        self.editFecha.setText("")
        self.editFecha.setAlignment(QtCore.Qt.AlignCenter)
        self.editFecha.setObjectName("editFecha")
        self.layout1.addWidget(self.editFecha)
        self.pushButton = QtWidgets.QPushButton(self.panelCliente)
        ...
        self.layout1.addWidget(self.pushButton)
